...
var vtJqPlotInterface = function() {
    ...
    this.renderBar = function() {
        var legendVisible = !!(this.data['data_labels'] && this.data['data_labels'].length);
        this.element.jqplot(this.data['chartData'] , {
            title: this.data['title'],
            ...
            legend: {
                ...
                showLabels	: legendVisible,
                showSwatch	: legendVisible,
                labels		: this.data['data_labels']
            }
        });
        if (legendVisible) {
            var legendTable = this.element.find('table.jqplot-table-legend');
            legendTable.css({
                width: 'auto',
                float: 'none',
                margin: '0 auto'
